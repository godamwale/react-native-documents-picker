 ...
 * */
export declare function pickDirectory<O extends DirectoryPickerOptions>(options?: O): Promise<O extends DirectoryPickerOptionsLongTerm ? DirectoryPickerResponseLongTerm : DirectoryPickerResponse>;
