 ...
 * */
export declare function pick<O extends DocumentPickerOptions>(options?: O): Promise<O extends DocumentPickerOptionsOpenLongTerm ? NonEmptyArray<DocumentPickerResponseOpenLongTerm> : NonEmptyArray<DocumentPickerResponse>>;
export {};
